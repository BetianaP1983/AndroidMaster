package com.betiana.androidmaster.exercises

/**
 * Las entradas de cine suelen tener un precio diferente según la edad de los espectadores.
 *
 * En el código inicial que se proporciona en el siguiente fragmento de código, escribe un programa que calcula los precios de estas entradas basado en la edad:
 *
 ...
 * Un valor de -1para indicar que el precio no es valido cuando un usuario ingresa una edad fuera de las especificaciones
